                            ...
                            case 0:
                                ...
                                messages.addTask( function() {
                                    ...
                                    if ( data != "succsess" ) {
                                        ...
                                        messages.type = "info"
                                        messages.show()
                                        listTasks.model = coreFunc.getTasks("&self=1&group="+selectedGroup)["tasks"]
                                    }
                                } )
                                break
                            case 1:
                                let model = []
                                let students = coreFunc.getUsers( 1, selectedGroup )["users"]
            ...
            ListView {
                ...
                delegate: TagListItem {
                    ...
                    onClicked: {
                        ...
                        listTasks.model = coreFunc.getTasks("&self=1&group="+modelData["group"])["tasks"]
